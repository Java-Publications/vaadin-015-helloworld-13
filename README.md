...
# Backend meets Frontend: Secure web applications with Apache Shiro
The foundation for security measures should be laid as early as possible in a project. This is especially true for the management of users and roles. The Apache project Shiro helps to secure web applications.
...
* german article [http://bit.ly/jaxenter-013](http://bit.ly/jaxenter-013)
